...
if __name__ == "__main__":
    ...
    for fold in args.folds:
        ...
        if args.crop_ratio == 1:
            if args.hflip:
                pred_path = '{}/{}_{}_fold{}_hflip.pt'.format(args.pred_dir, cfg['model_name'], cfg['image_size'], fold)
            else:
                pred_path = '{}/{}_{}_fold{}.pt'.format(args.pred_dir, cfg['model_name'], cfg['image_size'], fold)
        else:
            if args.hflip:
                pred_path = '{}/{}_{}_fold{}_crop{:.2f}_hflip.pt'.format(args.pred_dir, cfg['model_name'], cfg['image_size'], fold, args.crop_ratio)
            else:
                pred_path = '{}/{}_{}_fold{}_crop{:.2f}.pt'.format(args.pred_dir, cfg['model_name'], cfg['image_size'], fold, args.crop_ratio)
