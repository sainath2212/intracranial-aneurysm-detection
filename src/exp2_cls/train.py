...
if __name__ == "__main__":
    ...
    for epoch in range(cfg['epochs']):
        ...
        print('Epoch {} | train loss: {:.5f} | ema_val_auc: {:.5f}'.format(epoch, train_loss, ema_val_auc))
        ...
        if epoch == cfg['epochs_for_final_submission']:
            torch.save(model_ema.module.state_dict(), '{}/{}_{}_full_epoch{}_exp2.pt'.format(args.ckpt_dir, cfg['model_name'], cfg['image_size'], epoch))
            # break